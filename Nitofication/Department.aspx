<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="EVoting.Department" %>
    ...
    function w3_close() {
      ...
      overlayBg.style.display = "none";
        ...
        <div style="height: 438px; margin-bottom: 0px">
            ...
            <asp:Label ID="Label2" runat="server" Text="Department Description" style = "margin-left:26.1%;"></asp:Label>
            <br />
            <asp:TextBox ID="ADeptName" runat="server" placeholder = "Enter Department Name" Style ="width: 30%; border: none; margin-left:1.5%; border-bottom: 1px solid black; outline: none; height: 40px; color: black; 
    background-color: transparent;"></asp:TextBox> 
            <asp:TextBox ID="ADeptDesc" runat="server" placeholder = "Enter Department Description" Style ="margin-left: 6.5%;width: 50%; border: none; border-bottom: 1px solid black; outline: none; height: 40px; color: black; 
    background-color: transparent;"></asp:TextBox> <br /> <br />
            <asp:Button ID="AddNew" runat="server" Text="Save" style ="margin-left:84.5%; border-radius: 10px;" CssClass ="Submit" OnClick="Add_Click"/><br /> <br />
            <center>
                <asp:GridView ID="GridView1" runat="server" Height="30px" Width="1075px"  AutoGenerateColumns ="False" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2">
                    <Columns>
                        ...
                        <asp:BoundField DataField = "Department_Description" HeaderText = "Department Description" />
                    </Columns>
