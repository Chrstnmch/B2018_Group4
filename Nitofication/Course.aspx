<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Course.aspx.cs" Inherits="EVoting.Course" %>
    ...
    function w3_close() {
      ...
      overlayBg.style.display = "none";
        ...
        <div style="height: 438px; margin-bottom: 0px">
            ...
            <asp:TextBox ID="Course_Name" runat="server" placeholder = "Enter Course" Style ="margin-left: 6.5%;width: 50%; border: none; border-bottom: 1px solid black; outline: none; height: 40px; color: black; 
    background-color: transparent;"></asp:TextBox> <br /> <br />
            <asp:Button ID="AddCourse" runat="server" Text="Save" style ="margin-left:78.7%; border-radius: 10px;" CssClass ="Submit" OnClick = "Add_Click" /> <br /> <br />
            <center>
